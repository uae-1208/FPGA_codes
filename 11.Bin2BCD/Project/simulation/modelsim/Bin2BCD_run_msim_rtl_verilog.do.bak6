...
vlog -vlog01compat -work work +incdir+U:/Projects/FPGA/Examples/11.Bin2BCD/RTL {U:/Projects/FPGA/Examples/11.Bin2BCD/RTL/Bin2BCD.v}

vlog -vlog01compat -work work +incdir+U:/Projects/FPGA/Examples/11.Bin2BCD/Project/../Sim {U:/Projects/FPGA/Examples/11.Bin2BCD/Project/../Sim/Bin2BCD_TB.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  Bin2BCD_TB
