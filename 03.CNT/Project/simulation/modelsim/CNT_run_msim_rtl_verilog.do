...
vlog -vlog01compat -work work +incdir+U:/Projects/FPGA/Examples/3.CNT/RTL {U:/Projects/FPGA/Examples/3.CNT/RTL/CNT.v}

vlog -vlog01compat -work work +incdir+U:/Projects/FPGA/Examples/3.CNT/Project/../Sim {U:/Projects/FPGA/Examples/3.CNT/Project/../Sim/CNT_TB.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  CNT_TB
