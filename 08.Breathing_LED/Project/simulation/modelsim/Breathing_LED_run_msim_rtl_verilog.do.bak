...
vlog -vlog01compat -work work +incdir+U:/Projects/FPGA/Examples/8.Breathing_LED/RTL {U:/Projects/FPGA/Examples/8.Breathing_LED/RTL/Breathing_LED.v}

vlog -vlog01compat -work work +incdir+U:/Projects/FPGA/Examples/8.Breathing_LED/Project/../Sim {U:/Projects/FPGA/Examples/8.Breathing_LED/Project/../Sim/Breathing_LED_TB.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  Breathing_LED_TB
