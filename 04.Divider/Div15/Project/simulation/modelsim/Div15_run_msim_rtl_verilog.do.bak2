...
vlog -vlog01compat -work work +incdir+U:/Projects/FPGA/Examples/4.Divider/Div15/RTL {U:/Projects/FPGA/Examples/4.Divider/Div15/RTL/Div15.v}

vlog -vlog01compat -work work +incdir+U:/Projects/FPGA/Examples/4.Divider/Div15/Project/../Sim {U:/Projects/FPGA/Examples/4.Divider/Div15/Project/../Sim/Div15_TB.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  Div15_TB
